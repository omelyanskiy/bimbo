...
insert into usr(userId,fio,phone,login,pass,typId) values (Null,'Глухова Вероника Владимировн','89219567843','login9','pass9',4);
insert into usr(userId,fio,phone,login,pass,typId) values (Null,'Князев Арсений Андреевич','89219567844','login10','pass10',2);

insert into zayavka(zayavkaId,startDate,computerTechModel,problemDiscription,statId,computerTypeId,userId,commID) values (Null, '2023-06-06','RDOR GAMING RAGE H290','Выключается после 10 минут работы',1,1,1,1);
insert into zayavka(zayavkaId,startDate,computerTechModel,problemDiscription,statId,computerTypeId,userId,commID) values (Null, '2023-05-05','ASUS VivoBook Pro 15 M6500QH-HN034 синий','Сильно шумит и греется',1,2,2,2);
insert into zayavka(zayavkaId,startDate,computerTechModel,problemDiscription,statId,computerTypeId,userId,commID) values (Null, '2022-07-07','ARDOR GAMING Phantom PRO','Перестало работать колёсико',2,3,3,3);
insert into zayavka(zayavkaId,startDate,computerTechModel,problemDiscription,statId,computerTypeId,userId,commID) values (Null, '2023-08-02','Dark Project KD83A','Сломались некоторые клавиши',3,4,4,Null);
insert into zayavka(zayavkaId,startDate,computerTechModel,problemDiscription,statId,computerTypeId,userId,commID) values (Null, '2023-08-02','ASUS ROG Strix G15 G513RW-HQ177 серый','Не загружается система',3,2,5,Null);
